...
import s from './Vaiber.module.css';

const Vaiber = () => {
  return (
    <div className={s.multibutton}>
      <a
        className={s.multibutton__button}
        href="https://msng.link/o/?380638413090=vi"
        target="_blank">
        <svg
          version="1.1"
          ...
          style={{ enableBackground: 'new 0 0 512.076 512.076' }}
          xmlSpace="preserve">
      ...
      <a className={s.text} href="https://msng.link/o/?380638413090=vi" target="_blank">
        Напишите в вайбер
      </a>
    </div>
  );
